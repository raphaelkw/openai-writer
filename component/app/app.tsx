...
export default function App() {
  ...
  const getToneValue = async () => {
    getResult({ content: writing, type: TYPE.TONE, context: tone }).then(
      (response) => {
  ...
  const getStyleValue = async () => {
    getResult({ content: writing, type: TYPE.STYLE, context: style }).then(
      (response) => {
        setResponse(response);
      }
    );
  ...
  return (
    <div>
      <select
        className={styles.tone_change}
        onChange={handleToneChange}
        name="Change tone"
        id="change_tone_dropdown"
        value={tone}
      >
      ...
      <button
        className={styles.submit_button_tone}
        name="change_tone"
        id="change_tone_button"
        onClick={getToneValue}
      >
        Change Tone
      </button>
      ...
      <button
        className={styles.submit_button_action}
        id="change_style_button"
        onClick={getStyleValue}
      >
        Take Action
      </button>
